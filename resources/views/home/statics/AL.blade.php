...
<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			...
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				...
				<img src="{{asset('bootcss/home/AI/img/iali63.jpg')}}" tppabs="{{asset('img/iali63.jpg')}}"/>
			</div>
			<div id="/section-1/page-3" class="ft-page page-3 left-img" data-id="page-3">
				...
				<img src="{{asset('bootcss/home/AI/img/iali35.jpg')}}" tppabs="{{asset('img/iali35.jpg')}}"/>
			</div>
			<div id="/section-1/page-4" class="ft-page page-4 full-img" data-id="page-4">
				...
				<img src="{{asset('bootcss/home/AI/img/iali6.jpg')}}" tppabs="{{asset('img/iali6.jpg')}}"/>
			</div>
		</div>
		<div class="ft-section section-2" data-id="section-2">
			<div id="/section-2/page-1" class="ft-page page-5 full-img" data-id="page-1">
				...
				<img src="{{asset('bootcss/home/AI/img/iali19.jpg')}}" tppabs="{{asset('img/iali19.jpg')}}"/>
			</div>
		...
		<div class="ft-section section-3" data-id="section-3">
			<div id="/section-3/page-1" class="ft-page page-11 full-img" data-id="page-1">
				...
				<img src="{{asset('bootcss/home/AI/img/iali24.jpg')}}" tppabs="{{asset('img/iali24.jpg')}}"  />
			</div>
			<div id="/section-3/page-2" class="ft-page page-12" data-id="page-2">
				...
				<img src="{{asset('bootcss/home/AI/img/iali25.jpg')}}" tppabs="{{asset('img/iali25.jpg')}}" />
			</div>
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				<img src="{{asset('bootcss/home/AI/img/iali64.jpg')}}" tppabs="{{asset('img/iali64.jpg')}}" />
				<h3 id="text-13" contenteditable="true">可是崔崔的爱情又在哪里呢？</h3>
			</div>
			<div id="/section-3/page-4" class="ft-page page-14 left-img" data-id="page-4">
				<h3 id="text-14" contenteditable="true">在镜子里面吗？他不敢相信</h3>
				<img src="{{asset('bootcss/home/AI/img/iali46.jpg')}}" tppabs="{{asset('img/iali46.jpg')}}" />
			</div>
			<div id="/section-3/page-5" class="ft-page page-15 left-img" data-id="page-5">
				...
				<img src="{{asset('bootcss/home/AI/img/iali45.jpg')}}" tppabs="{{asset('img/iali45.jpg')}}" />
			</div>
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				<h3><span id="text-17" contenteditable="true">于是，崔崔一个人继续向前走</span><br /><span id="text-18" contenteditable="true">走在茫茫的雪地上</span></h3>
				<img src="{{asset('bootcss/home/AI/img/iali66.jpg')}}" tppabs="{{asset('img/iali66.jpg')}}" />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="true">直到有一天崔崔与小公主相遇了</h3>
				<img src="{{asset('bootcss/home/AI/img/iali16.jpg')}}" tppabs="{{asset('img/iali16.jpg')}}" />
			</div>
		</div>
		<div class="ft-section section-4" data-id="section-4">
			<div id="/section-4/page-1" class="ft-page page-18 full-img" data-id="page-1">
				<p class="text" id="text-20" contenteditable="true">崔崔喜欢小公主，因为小公主的出现，崔崔脸上有了更加灿烂的笑容</p>
				<img src="{{asset('bootcss/home/AI/img/iali11.jpg')}}" tppabs="{{asset('img/iali11.jpg')}}"  />
			</div>
			<div id="/section-4/page-2" class="ft-page page-19" data-id="page-2">
				<h3 id="text-21" contenteditable="true">可是小公主会喜欢崔崔吗？</h3>
				<img src="{{asset('bootcss/home/AI/img/iali75.jpg')}}" tppabs="{{asset('img/iali75.jpg')}}" />
			</div>
			<div id="/section-4/page-3" class="ft-page page-20" data-id="page-3">
				<img src="{{asset('bootcss/home/AI/img/iali59.png')}}" tppabs="{{asset('img/iali59.png')}}" />
				<h3 id="text-22" contenteditable="true">终于有一天，崔崔鼓起了勇气</h3>
				<img src="{{asset('bootcss/home/AI/img/iali9.jpg')}}" tppabs="{{asset('img/iali9.jpg')}}" />
			</div>
			<div id="/section-4/page-4" class="ft-page page-21" data-id="page-4">
				<h3 id="text-23" contenteditable="true">崔崔好高兴</h3>
				<img src="{{asset('bootcss/home/AI/img/iali59.png')}}" tppabs="{{asset('img/iali59.png')}}" />
			</div>
			<div id="/section-4/page-5" class="ft-page page-22 left-img" data-id="page-5">
				<h3 id="text-24" contenteditable="true">每天崔崔都会去找小公主</h3>
				<img src="{{asset('bootcss/home/AI/img/iali4.jpg')}}" tppabs="{{asset('img/iali4.jpg')}}" />
			</div>
			<div id="/section-4/page-6" class="ft-page page-23 left-img" data-id="page-6">
				<h3 id="text-25" contenteditable="true">然后两个人一起出去玩</h3>
				<img src="{{asset('bootcss/home/AI/img/iali44.jpg')}}" tppabs="{{asset('img/iali44.jpg')}}" />
			</div>
			<div id="/section-4/page-7" class="ft-page page-24 full-img" data-id="page-7">
				<h3 id="text-26" contenteditable="true">晚上崔崔会把小公主送回家</h3>
				<img src="{{asset('bootcss/home/AI/img/iali32.jpg')}}" tppabs="{{asset('img/iali32.jpg')}}" />
			</div>
		</div>
		<div class="ft-section section-5" data-id="section-5">
			<div id="/section-5/page-1" class="ft-page page-25 left-img" data-id="page-1">
				<h3><span id="text-27" contenteditable="true">直到很晚</span><br /><span id="text-28" contenteditable="true">崔崔才会一个人回家</span></h3>
				<img src="{{asset('bootcss/home/AI/img/iali37.jpg')}}" tppabs="{{asset('img/iali37.jpg')}}" />
			</div>
			<div id="/section-5/page-2" class="ft-page page-26 top-text" data-id="page-2">
				<h3 id="text-29" contenteditable="true">然后高兴地进入梦乡，希望梦到小公主</h3>
				<img src="{{asset('bootcss/home/AI/img/iali10.gif')}}" tppabs="{{asset('img/iali10.gif')}}" />
			</div>
			<div id="/section-5/page-3" class="ft-page page-27" data-id="page-3">
				<h3 id="text-30" contenteditable="true">崔崔很快就成为了小公主的逛街助手</h3>
				<img src="{{asset('bootcss/home/AI/img/iali67.jpg')}}" tppabs="{{asset('img/iali67.jpg')}}"  />
			</div>
			<div id="/section-5/page-4" class="ft-page page-28" data-id="page-4">
				<h3 id="text-31" contenteditable="true">崔崔和小公主一起去了好多地方玩</h3>
				<img src="{{asset('bootcss/home/AI/img/iali40.jpg')}}" tppabs="{{asset('img/iali40.jpg')}}" />
			</div>
			<div id="/section-5/page-5" class="ft-page page-29" data-id="page-5">
				<h3 id="text-32" contenteditable="true">崔崔也和小公主一样成为了一个吃货</h3>
				<img src="{{asset('bootcss/home/AI/img/iali12.jpg')}}" tppabs="{{asset('img/iali12.jpg')}}" />
			</div>
			<div id="/section-5/page-6" class="ft-page page-30" data-id="page-6">
				<h3 id="text-33" contenteditable="true">后来，他们搬到了一起</h3>
				<img src="{{asset('bootcss/home/AI/img/iali76.gif')}}" tppabs="{{asset('img/iali76.gif')}}" />
			</div>
			<div id="/section-5/page-7" class="ft-page page-31" data-id="page-7">
				<h3 id="text-34" contenteditable="true">于是崔崔开始学习新的技能</h3>
				<img src="{{asset('bootcss/home/AI/img/iali77.jpg')}}" tppabs="{{asset('img/iali77.jpg')}}" />
			</div>
		</div>
		<div class="ft-section section-6" data-id="section-6">
			<div id="/section-6/page-1" class="ft-page page-32" data-id="page-1">
				...
				<img src="{{asset('bootcss/home/AI/img/iali62.jpg')}}" tppabs="{{asset('img/iali62.jpg')}}"  />
			</div>
			<div id="/section-6/page-2" class="ft-page page-33 top-text" data-id="page-2">
				...
				<img src="{{asset('bootcss/home/AI/img/iali3.jpg')}}" tppabs="{{asset('img/iali3.jpg')}}" />
			</div>
			...
			<div id="/section-6/page-4" class="ft-page page-35" data-id="page-4">
				<h3><span id="text-38" contenteditable="true">崔崔感觉自己好幸福。</span><br /><span id="text-39" contenteditable="true">因为自己有了家</span><br /><span id="text-40" contenteditable="true">那个有小公主在的地方</span></h3>
				<img src="{{asset('bootcss/home/AI/img/iali8.gif')}}" tppabs="{{asset('img/iali8.gif')}}" />
			</div>
			<div id="/section-6/page-5" class="ft-page page-36 full-img" data-id="page-5">
				<h3 id="text-41" contenteditable="true">他们偶尔也会吵架</h3>
				<img src="{{asset('bootcss/home/AI/img/iali31.jpg')}}" tppabs="{{asset('img/iali31.jpg')}}" />
			</div>
			<div id="/section-6/page-6" class="ft-page page-37 left-img" data-id="page-6">
				<h3 id="text-42" contenteditable="true">崔崔不想这样</h3>
				<img src="{{asset('bootcss/home/AI/img/iali49.jpg')}}" tppabs="{{asset('img/iali49.jpg')}}" />
			</div>
			<div id="/section-6/page-7" class="ft-page page-38 bottom-text" data-id="page-7">
				<img src="{{asset('bootcss/home/AI/img/iali21.jpg')}}" tppabs="{{asset('img/iali21.jpg')}}" />
				<h3 id="text-43" contenteditable="true">一定是我有什么做的不对，崔崔在想</h3>
			</div>
		</div>
		<div class="ft-section section-7" data-id="section-7">
			<div id="/section-7/page-1" class="ft-page page-39 left-img" data-id="page-1">
				<h3 id="text-44" contenteditable="true">如果没有小公主在身边，窗外就没有风景</h3>
				<img src="{{asset('bootcss/home/AI/img/iali2.jpg')}}" tppabs="{{asset('img/iali2.jpg')}}" />
			</div>
			<div id="/section-7/page-2" class="ft-page page-40" data-id="page-2">
				<h3 id="text-45" contenteditable="true">如果没有小公主在身后</h3>
				<img src="{{asset('bootcss/home/AI/img/iali14.jpg')}}" tppabs="{{asset('img/iali14.jpg')}}"  />
			</div>
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				<img src="{{asset('bootcss/home/AI/img/iali30_1.jpg')}}" tppabs="{{asset('img/iali30_1.jpg')}}" class='img1'/>
				<img src="{{asset('bootcss/home/AI/img/iali30_2.jpg')}}" tppabs="{{asset('img/iali30_2.jpg')}}" class='img2'/>
			...
			<div id="/section-7/page-6" class="ft-page page-44 left-img" data-id="page-6">
				...
				<img src="{{asset('bootcss/home/AI/img/iali0.jpg')}}" tppabs="{{asset('img/iali0.jpg')}}" />
			</div>
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				<h3><span id="text-52" contenteditable="true">再到后来，小公主要过生日了</span><br /><span id="text-53" contenteditable="true">崔崔开始为小公主准备礼物</span></h3>
				<img src="{{asset('bootcss/home/AI/img/iali18.jpg')}}" tppabs="{{asset('img/iali18.jpg')}}" />
			</div>
		</div>
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				<img src="{{asset('bootcss/home/AI/img/iali57.gif')}}" tppabs="{{asset('img/iali57.gif')}}" />
				<h3>
					<span id="text-54" contenteditable="true">看着礼物一件件准备好了</span>
					<span id="text-55" contenteditable="true">崔崔好开心</span>
					<span id="text-56" contenteditable="true">因为他想象着小公主收到礼物时</span>
					<span id="text-57" contenteditable="true">开心的样子</span>
				</h3>
			</div>
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				<img src="{{asset('bootcss/home/AI/img/iali58.jpg')}}" tppabs="{{asset('img/iali58.jpg')}}" />
				<h3>
					<span id="text-58" contenteditable="true">想想后面还有一辈子</span>
					<span id="text-59" contenteditable="true">崔崔好开心</span>
					<span id="text-60" contenteditable="true">因为可以和小公主</span>
			...
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				<p><span id="text-62" contenteditable="true">崔崔也会继续努力</span><br />
				<span id="text-63" contenteditable="true">为了他和小公主的梦之城堡</span></p>
				<img src="{{asset('bootcss/home/AI/img/iali65.jpg')}}" tppabs="{{asset('img/iali65.jpg')}}"  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
				<h3><span id="text-64" contenteditable="true">崔崔很幸福，因为他找到了小公主。</span><br />
				<span id="text-65" contenteditable="true">他相信后面的每天都会是快乐的。</span><br /></h3>
				<img src="{{asset('bootcss/home/AI/img/iali71.jpg')}}" tppabs="{{asset('img/iali71.jpg')}}" />
			</div>
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				<p class='text' id="text-66" contenteditable="true">后来的一天，小公主说她不敢坐山车了，于是崔崔就带她到别的地方玩。这只是他们幸福生活中的一件小事，小到无法引起别人的注意。可这是属于崔崔和小公主的幸福生活。</p>
				<img src="{{asset('bootcss/home/AI/img/iali50_1.jpg')}}" tppabs="{{asset('img/iali50_1.jpg')}}" class='img1' />
				<img src="{{asset('bootcss/home/AI/img/iali50_2.jpg')}}" tppabs="{{asset('img/iali50_2.jpg')}}" class='img2' />
			</div>
			<div id="/section-8/page-6" class="ft-page page-51" data-id="page-6">
				<p><span id="text-67" contenteditable="true">小公主：永远有多远？</span><br />
				<span id="text-68" contenteditable="true">崔崔：比时间多一秒就是永远，我会永远爱你</span><br />
				<span id="text-69" contenteditable="true">小公主：世界有多大？</span><br />
				<span id="text-70" contenteditable="true">崔崔：你走到哪里，世界就有多大</span></p>
			</div>
		</div>
		<div class="ft-section section-9" data-id="section-9">
			<div id="/section-9/page-1" class="ft-page page-52 full-img" data-id="page-1">
				...
				<img src="{{asset('bootcss/home/AI/img/iali20.jpg')}}" tppabs="{{asset('img/iali20.jpg')}}"  />
			</div>
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				<img src="{{asset('bootcss/home/AI/img/14915.jpg')}}" tppabs="img/14915.jpg')}}" />
				<p class="text">
					<span id="text-73" contenteditable="true">崔崔和小公主的故事会一直继续下去。</span><br />
					<span id="text-74" contenteditable="true">无论精彩、平淡都会是他们喜欢的。</span><br />
					<br />
					<br />
					<span> -- 按“Esc" 键有惊喜</span>
          <a class="navbar-brand" href="{{route('welcome')}}">回到首页</a>
				</p>
			</div>
		</div>
	</div>
